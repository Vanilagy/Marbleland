 ...
 */
export class haxe_ds_StringMap<T> implements haxe_IMap<K,V> {
	/**
...
export class LightMap {
	...
	lightdirmap: number[];
	keepLightMap: number;
	writeLightMap(io: io_BytesWriter, version: Version): void;
